...
df = df.drop([
    ...
    "Average Rating",
    "Total Spend",
    "Days Since Last Purchase"  # Remove dominating feature for realism
], axis=1)

# ===============================
# FIX NUMERIC COLUMNS
# ===============================
numeric_cols = ["Age", "Items Purchased", "Discount Applied"]
...
print("Cross Validation Accuracy:", round(cv_score.mean(), 3))
